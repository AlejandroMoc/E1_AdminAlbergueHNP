...
useEffect(() =>{
  fetch('http://localhost:8008/deudaCliente/'+props.id_cliente)
  .then((res) => res.json())
...
const handleBtRegistroClick = async () => {
      try {
        await fetch('http://localhost:8008/registrarPago', {
          method: 'POST',
...
useEffect(() => {
  fetch('http://localhost:8008/vetado/' + props.id_cliente)
    .then((res) => res.json())
    .then((data) => {
...
// console.log(showVetadoSelect)
  ...
  const vetarCliente = (id_u, id_c, n_v) => {
    fetch('http://localhost:8008/banclient', {
        method: 'POST',
  ...
  const desvetarCliente = (id_c) => {
    fetch('http://localhost:8008/unbanclient', {
        method: 'POST',
...
useEffect(() =>{
  fetch('http://localhost:8008/notasVeto/'+props.id_cliente)
  .then((res) => res.json())
