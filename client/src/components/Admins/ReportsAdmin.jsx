...
const generatePDF = useReactToPrint({
  content: () => {
    ...
    imageElement.classList.add('image-element'); // Agregamos la clase a la imagen
    ...
    generatedElement.classList.add('generated-element'); // Agregamos la clase al texto generado
